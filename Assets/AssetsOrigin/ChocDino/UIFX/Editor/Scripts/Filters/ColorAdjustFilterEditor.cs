...
namespace ChocDino.UIFX.Editor
{
	...
	{
		private static GUIContent Content_ShowAdvancedOptions = new GUIContent("Show Advanced Options");
		private static GUIContent Content_Adjust = new GUIContent("Adjust");
		private static GUIContent Content_Advanced = new GUIContent("Advanced");
		private static GUIContent Content_Brightness = new GUIContent("Brightness");
		private static GUIContent Content_Contrast = new GUIContent("Contrast");
		private static GUIContent Content_Posterize = new GUIContent("Posterize");
		private static GUIContent Content_Red = new GUIContent("Red");
		private static GUIContent Content_Green = new GUIContent("Green");
		private static GUIContent Content_Blue = new GUIContent("Blue");
		private static GUIContent Content_Alpha = new GUIContent("Alpha");
		...
		private readonly AboutInfo aboutInfo = 
				new AboutInfo("UIFX - Color Adjust Filter\n© Chocolate Dinosaur Ltd", "uifx-icon")
				{
